namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #171
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_171", menuName = "CarromArena/Striker #171")]
    public class StrikerSkillDefinition_171 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_171";
        [SerializeField] private float maxShotForce = 45.0f + (171 * 0.1f);
