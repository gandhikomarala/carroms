namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #223
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_223", menuName = "CarromArena/Striker #223")]
    public class StrikerSkillDefinition_223 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_223";
        [SerializeField] private float maxShotForce = 45.0f + (223 * 0.1f);
