namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #136
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_136", menuName = "CarromArena/Striker #136")]
    public class StrikerSkillDefinition_136 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_136";
        [SerializeField] private float maxShotForce = 45.0f + (136 * 0.1f);
