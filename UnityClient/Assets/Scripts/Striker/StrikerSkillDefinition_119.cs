namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #119
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_119", menuName = "CarromArena/Striker #119")]
    public class StrikerSkillDefinition_119 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_119";
        [SerializeField] private float maxShotForce = 45.0f + (119 * 0.1f);
