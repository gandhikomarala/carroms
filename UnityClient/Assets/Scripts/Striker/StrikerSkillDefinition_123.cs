namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #123
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_123", menuName = "CarromArena/Striker #123")]
    public class StrikerSkillDefinition_123 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_123";
        [SerializeField] private float maxShotForce = 45.0f + (123 * 0.1f);
