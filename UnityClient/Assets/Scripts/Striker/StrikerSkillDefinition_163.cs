namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #163
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_163", menuName = "CarromArena/Striker #163")]
    public class StrikerSkillDefinition_163 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_163";
        [SerializeField] private float maxShotForce = 45.0f + (163 * 0.1f);
