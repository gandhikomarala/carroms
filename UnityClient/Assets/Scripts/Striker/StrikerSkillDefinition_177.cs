namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #177
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_177", menuName = "CarromArena/Striker #177")]
    public class StrikerSkillDefinition_177 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_177";
        [SerializeField] private float maxShotForce = 45.0f + (177 * 0.1f);
