namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #176
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_176", menuName = "CarromArena/Striker #176")]
    public class StrikerSkillDefinition_176 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_176";
        [SerializeField] private float maxShotForce = 45.0f + (176 * 0.1f);
