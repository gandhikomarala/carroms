namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #030
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_030", menuName = "CarromArena/Striker #030")]
    public class StrikerSkillDefinition_030 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_030";
        [SerializeField] private float maxShotForce = 45.0f + (30 * 0.1f);
