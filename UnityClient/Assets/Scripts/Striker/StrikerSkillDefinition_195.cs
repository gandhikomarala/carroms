namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #195
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_195", menuName = "CarromArena/Striker #195")]
    public class StrikerSkillDefinition_195 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_195";
        [SerializeField] private float maxShotForce = 45.0f + (195 * 0.1f);
