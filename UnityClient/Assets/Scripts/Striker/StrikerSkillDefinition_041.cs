namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #041
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_041", menuName = "CarromArena/Striker #041")]
    public class StrikerSkillDefinition_041 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_041";
        [SerializeField] private float maxShotForce = 45.0f + (41 * 0.1f);
