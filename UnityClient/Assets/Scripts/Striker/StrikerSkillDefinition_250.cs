namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #250
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_250", menuName = "CarromArena/Striker #250")]
    public class StrikerSkillDefinition_250 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_250";
        [SerializeField] private float maxShotForce = 45.0f + (250 * 0.1f);
