namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #054
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_054", menuName = "CarromArena/Striker #054")]
    public class StrikerSkillDefinition_054 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_054";
        [SerializeField] private float maxShotForce = 45.0f + (54 * 0.1f);
