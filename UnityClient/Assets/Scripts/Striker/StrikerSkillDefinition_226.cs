namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #226
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_226", menuName = "CarromArena/Striker #226")]
    public class StrikerSkillDefinition_226 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_226";
        [SerializeField] private float maxShotForce = 45.0f + (226 * 0.1f);
