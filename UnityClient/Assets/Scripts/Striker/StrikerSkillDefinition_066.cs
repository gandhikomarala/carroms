namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #066
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_066", menuName = "CarromArena/Striker #066")]
    public class StrikerSkillDefinition_066 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_066";
        [SerializeField] private float maxShotForce = 45.0f + (66 * 0.1f);
