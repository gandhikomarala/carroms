namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #109
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_109", menuName = "CarromArena/Striker #109")]
    public class StrikerSkillDefinition_109 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_109";
        [SerializeField] private float maxShotForce = 45.0f + (109 * 0.1f);
