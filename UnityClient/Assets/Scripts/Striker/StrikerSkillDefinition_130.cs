namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #130
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_130", menuName = "CarromArena/Striker #130")]
    public class StrikerSkillDefinition_130 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_130";
        [SerializeField] private float maxShotForce = 45.0f + (130 * 0.1f);
