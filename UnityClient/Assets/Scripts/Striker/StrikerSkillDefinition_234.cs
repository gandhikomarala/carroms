namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #234
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_234", menuName = "CarromArena/Striker #234")]
    public class StrikerSkillDefinition_234 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_234";
        [SerializeField] private float maxShotForce = 45.0f + (234 * 0.1f);
