namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #096
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_096", menuName = "CarromArena/Striker #096")]
    public class StrikerSkillDefinition_096 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_096";
        [SerializeField] private float maxShotForce = 45.0f + (96 * 0.1f);
