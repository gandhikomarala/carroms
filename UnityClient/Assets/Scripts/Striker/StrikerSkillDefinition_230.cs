namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #230
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_230", menuName = "CarromArena/Striker #230")]
    public class StrikerSkillDefinition_230 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_230";
        [SerializeField] private float maxShotForce = 45.0f + (230 * 0.1f);
