namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #241
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_241", menuName = "CarromArena/Striker #241")]
    public class StrikerSkillDefinition_241 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_241";
        [SerializeField] private float maxShotForce = 45.0f + (241 * 0.1f);
