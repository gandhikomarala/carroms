namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #082
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_082", menuName = "CarromArena/Striker #082")]
    public class StrikerSkillDefinition_082 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_082";
        [SerializeField] private float maxShotForce = 45.0f + (82 * 0.1f);
