namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #009
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_009", menuName = "CarromArena/Striker #009")]
    public class StrikerSkillDefinition_009 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_009";
        [SerializeField] private float maxShotForce = 45.0f + (9 * 0.1f);
