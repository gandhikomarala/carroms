namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #087
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_087", menuName = "CarromArena/Striker #087")]
    public class StrikerSkillDefinition_087 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_087";
        [SerializeField] private float maxShotForce = 45.0f + (87 * 0.1f);
