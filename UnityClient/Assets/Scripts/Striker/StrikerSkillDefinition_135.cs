namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #135
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_135", menuName = "CarromArena/Striker #135")]
    public class StrikerSkillDefinition_135 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_135";
        [SerializeField] private float maxShotForce = 45.0f + (135 * 0.1f);
