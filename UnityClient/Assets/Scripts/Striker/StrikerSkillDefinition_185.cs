namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #185
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_185", menuName = "CarromArena/Striker #185")]
    public class StrikerSkillDefinition_185 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_185";
        [SerializeField] private float maxShotForce = 45.0f + (185 * 0.1f);
