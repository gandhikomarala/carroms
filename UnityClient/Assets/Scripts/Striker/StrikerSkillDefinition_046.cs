namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #046
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_046", menuName = "CarromArena/Striker #046")]
    public class StrikerSkillDefinition_046 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_046";
        [SerializeField] private float maxShotForce = 45.0f + (46 * 0.1f);
