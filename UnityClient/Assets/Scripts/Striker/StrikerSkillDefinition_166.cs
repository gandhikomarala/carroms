namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #166
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_166", menuName = "CarromArena/Striker #166")]
    public class StrikerSkillDefinition_166 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_166";
        [SerializeField] private float maxShotForce = 45.0f + (166 * 0.1f);
