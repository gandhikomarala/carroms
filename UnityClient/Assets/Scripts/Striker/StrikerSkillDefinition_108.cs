namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #108
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_108", menuName = "CarromArena/Striker #108")]
    public class StrikerSkillDefinition_108 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_108";
        [SerializeField] private float maxShotForce = 45.0f + (108 * 0.1f);
