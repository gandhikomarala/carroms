namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #240
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_240", menuName = "CarromArena/Striker #240")]
    public class StrikerSkillDefinition_240 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_240";
        [SerializeField] private float maxShotForce = 45.0f + (240 * 0.1f);
