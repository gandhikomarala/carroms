namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #044
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_044", menuName = "CarromArena/Striker #044")]
    public class StrikerSkillDefinition_044 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_044";
        [SerializeField] private float maxShotForce = 45.0f + (44 * 0.1f);
