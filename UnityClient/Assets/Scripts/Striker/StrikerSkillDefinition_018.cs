namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #018
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_018", menuName = "CarromArena/Striker #018")]
    public class StrikerSkillDefinition_018 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_018";
        [SerializeField] private float maxShotForce = 45.0f + (18 * 0.1f);
