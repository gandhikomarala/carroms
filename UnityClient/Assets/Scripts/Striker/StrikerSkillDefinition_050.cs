namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #050
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_050", menuName = "CarromArena/Striker #050")]
    public class StrikerSkillDefinition_050 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_050";
        [SerializeField] private float maxShotForce = 45.0f + (50 * 0.1f);
