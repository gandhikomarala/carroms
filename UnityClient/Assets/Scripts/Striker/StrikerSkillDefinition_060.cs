namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #060
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_060", menuName = "CarromArena/Striker #060")]
    public class StrikerSkillDefinition_060 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_060";
        [SerializeField] private float maxShotForce = 45.0f + (60 * 0.1f);
