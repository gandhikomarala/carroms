namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #215
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_215", menuName = "CarromArena/Striker #215")]
    public class StrikerSkillDefinition_215 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_215";
        [SerializeField] private float maxShotForce = 45.0f + (215 * 0.1f);
