namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #053
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_053", menuName = "CarromArena/Striker #053")]
    public class StrikerSkillDefinition_053 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_053";
        [SerializeField] private float maxShotForce = 45.0f + (53 * 0.1f);
