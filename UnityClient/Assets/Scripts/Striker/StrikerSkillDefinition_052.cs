namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #052
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_052", menuName = "CarromArena/Striker #052")]
    public class StrikerSkillDefinition_052 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_052";
        [SerializeField] private float maxShotForce = 45.0f + (52 * 0.1f);
