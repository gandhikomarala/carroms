namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #076
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_076", menuName = "CarromArena/Striker #076")]
    public class StrikerSkillDefinition_076 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_076";
        [SerializeField] private float maxShotForce = 45.0f + (76 * 0.1f);
