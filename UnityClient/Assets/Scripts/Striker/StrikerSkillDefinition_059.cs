namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #059
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_059", menuName = "CarromArena/Striker #059")]
    public class StrikerSkillDefinition_059 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_059";
        [SerializeField] private float maxShotForce = 45.0f + (59 * 0.1f);
