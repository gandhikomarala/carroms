namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #157
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_157", menuName = "CarromArena/Striker #157")]
    public class StrikerSkillDefinition_157 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_157";
        [SerializeField] private float maxShotForce = 45.0f + (157 * 0.1f);
