namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #217
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_217", menuName = "CarromArena/Striker #217")]
    public class StrikerSkillDefinition_217 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_217";
        [SerializeField] private float maxShotForce = 45.0f + (217 * 0.1f);
