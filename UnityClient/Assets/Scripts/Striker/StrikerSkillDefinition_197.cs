namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #197
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_197", menuName = "CarromArena/Striker #197")]
    public class StrikerSkillDefinition_197 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_197";
        [SerializeField] private float maxShotForce = 45.0f + (197 * 0.1f);
