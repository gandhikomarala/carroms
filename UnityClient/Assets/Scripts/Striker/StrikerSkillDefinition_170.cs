namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #170
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_170", menuName = "CarromArena/Striker #170")]
    public class StrikerSkillDefinition_170 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_170";
        [SerializeField] private float maxShotForce = 45.0f + (170 * 0.1f);
