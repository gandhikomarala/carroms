namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #027
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_027", menuName = "CarromArena/Striker #027")]
    public class StrikerSkillDefinition_027 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_027";
        [SerializeField] private float maxShotForce = 45.0f + (27 * 0.1f);
