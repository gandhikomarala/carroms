namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #242
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_242", menuName = "CarromArena/Striker #242")]
    public class StrikerSkillDefinition_242 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_242";
        [SerializeField] private float maxShotForce = 45.0f + (242 * 0.1f);
