namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #168
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_168", menuName = "CarromArena/Striker #168")]
    public class StrikerSkillDefinition_168 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_168";
        [SerializeField] private float maxShotForce = 45.0f + (168 * 0.1f);
