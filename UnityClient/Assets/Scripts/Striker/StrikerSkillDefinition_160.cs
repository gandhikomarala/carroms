namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #160
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_160", menuName = "CarromArena/Striker #160")]
    public class StrikerSkillDefinition_160 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_160";
        [SerializeField] private float maxShotForce = 45.0f + (160 * 0.1f);
