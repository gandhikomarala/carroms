namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #191
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_191", menuName = "CarromArena/Striker #191")]
    public class StrikerSkillDefinition_191 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_191";
        [SerializeField] private float maxShotForce = 45.0f + (191 * 0.1f);
