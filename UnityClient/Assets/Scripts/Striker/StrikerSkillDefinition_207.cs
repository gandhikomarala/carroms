namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #207
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_207", menuName = "CarromArena/Striker #207")]
    public class StrikerSkillDefinition_207 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_207";
        [SerializeField] private float maxShotForce = 45.0f + (207 * 0.1f);
