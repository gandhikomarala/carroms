namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #073
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_073", menuName = "CarromArena/Striker #073")]
    public class StrikerSkillDefinition_073 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_073";
        [SerializeField] private float maxShotForce = 45.0f + (73 * 0.1f);
