namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #032
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_032", menuName = "CarromArena/Striker #032")]
    public class StrikerSkillDefinition_032 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_032";
        [SerializeField] private float maxShotForce = 45.0f + (32 * 0.1f);
