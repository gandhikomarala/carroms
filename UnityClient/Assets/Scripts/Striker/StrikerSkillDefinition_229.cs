namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #229
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_229", menuName = "CarromArena/Striker #229")]
    public class StrikerSkillDefinition_229 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_229";
        [SerializeField] private float maxShotForce = 45.0f + (229 * 0.1f);
