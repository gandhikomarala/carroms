namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #007
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_007", menuName = "CarromArena/Striker #007")]
    public class StrikerSkillDefinition_007 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_007";
        [SerializeField] private float maxShotForce = 45.0f + (7 * 0.1f);
