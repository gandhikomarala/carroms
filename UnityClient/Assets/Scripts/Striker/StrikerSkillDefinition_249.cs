namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #249
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_249", menuName = "CarromArena/Striker #249")]
    public class StrikerSkillDefinition_249 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_249";
        [SerializeField] private float maxShotForce = 45.0f + (249 * 0.1f);
