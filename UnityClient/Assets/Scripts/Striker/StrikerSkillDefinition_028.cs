namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #028
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_028", menuName = "CarromArena/Striker #028")]
    public class StrikerSkillDefinition_028 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_028";
        [SerializeField] private float maxShotForce = 45.0f + (28 * 0.1f);
