namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #071
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_071", menuName = "CarromArena/Striker #071")]
    public class StrikerSkillDefinition_071 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_071";
        [SerializeField] private float maxShotForce = 45.0f + (71 * 0.1f);
