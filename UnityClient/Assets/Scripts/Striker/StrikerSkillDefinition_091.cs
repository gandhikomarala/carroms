namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #091
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_091", menuName = "CarromArena/Striker #091")]
    public class StrikerSkillDefinition_091 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_091";
        [SerializeField] private float maxShotForce = 45.0f + (91 * 0.1f);
