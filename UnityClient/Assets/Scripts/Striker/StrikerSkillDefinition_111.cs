namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #111
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_111", menuName = "CarromArena/Striker #111")]
    public class StrikerSkillDefinition_111 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_111";
        [SerializeField] private float maxShotForce = 45.0f + (111 * 0.1f);
