namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #117
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_117", menuName = "CarromArena/Striker #117")]
    public class StrikerSkillDefinition_117 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_117";
        [SerializeField] private float maxShotForce = 45.0f + (117 * 0.1f);
