namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #098
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_098", menuName = "CarromArena/Striker #098")]
    public class StrikerSkillDefinition_098 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_098";
        [SerializeField] private float maxShotForce = 45.0f + (98 * 0.1f);
