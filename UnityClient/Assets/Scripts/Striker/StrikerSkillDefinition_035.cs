namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #035
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_035", menuName = "CarromArena/Striker #035")]
    public class StrikerSkillDefinition_035 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_035";
        [SerializeField] private float maxShotForce = 45.0f + (35 * 0.1f);
