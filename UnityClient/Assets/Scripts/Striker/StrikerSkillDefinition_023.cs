namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #023
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_023", menuName = "CarromArena/Striker #023")]
    public class StrikerSkillDefinition_023 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_023";
        [SerializeField] private float maxShotForce = 45.0f + (23 * 0.1f);
