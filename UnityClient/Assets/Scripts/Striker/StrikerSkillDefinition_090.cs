namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #090
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_090", menuName = "CarromArena/Striker #090")]
    public class StrikerSkillDefinition_090 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_090";
        [SerializeField] private float maxShotForce = 45.0f + (90 * 0.1f);
