namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #211
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_211", menuName = "CarromArena/Striker #211")]
    public class StrikerSkillDefinition_211 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_211";
        [SerializeField] private float maxShotForce = 45.0f + (211 * 0.1f);
