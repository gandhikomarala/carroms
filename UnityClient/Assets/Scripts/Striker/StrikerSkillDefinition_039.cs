namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #039
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_039", menuName = "CarromArena/Striker #039")]
    public class StrikerSkillDefinition_039 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_039";
        [SerializeField] private float maxShotForce = 45.0f + (39 * 0.1f);
