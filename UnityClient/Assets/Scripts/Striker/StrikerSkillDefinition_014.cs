namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #014
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_014", menuName = "CarromArena/Striker #014")]
    public class StrikerSkillDefinition_014 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_014";
        [SerializeField] private float maxShotForce = 45.0f + (14 * 0.1f);
