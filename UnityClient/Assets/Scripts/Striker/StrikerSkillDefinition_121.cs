namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #121
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_121", menuName = "CarromArena/Striker #121")]
    public class StrikerSkillDefinition_121 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_121";
        [SerializeField] private float maxShotForce = 45.0f + (121 * 0.1f);
