namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #085
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_085", menuName = "CarromArena/Striker #085")]
    public class StrikerSkillDefinition_085 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_085";
        [SerializeField] private float maxShotForce = 45.0f + (85 * 0.1f);
