namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #031
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_031", menuName = "CarromArena/Striker #031")]
    public class StrikerSkillDefinition_031 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_031";
        [SerializeField] private float maxShotForce = 45.0f + (31 * 0.1f);
