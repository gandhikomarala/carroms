namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #063
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_063", menuName = "CarromArena/Striker #063")]
    public class StrikerSkillDefinition_063 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_063";
        [SerializeField] private float maxShotForce = 45.0f + (63 * 0.1f);
