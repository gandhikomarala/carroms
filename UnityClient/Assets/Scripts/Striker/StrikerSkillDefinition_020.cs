namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #020
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_020", menuName = "CarromArena/Striker #020")]
    public class StrikerSkillDefinition_020 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_020";
        [SerializeField] private float maxShotForce = 45.0f + (20 * 0.1f);
