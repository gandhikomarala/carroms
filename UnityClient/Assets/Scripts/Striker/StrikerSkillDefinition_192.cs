namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #192
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_192", menuName = "CarromArena/Striker #192")]
    public class StrikerSkillDefinition_192 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_192";
        [SerializeField] private float maxShotForce = 45.0f + (192 * 0.1f);
