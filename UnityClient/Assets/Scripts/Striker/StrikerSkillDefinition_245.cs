namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #245
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_245", menuName = "CarromArena/Striker #245")]
    public class StrikerSkillDefinition_245 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_245";
        [SerializeField] private float maxShotForce = 45.0f + (245 * 0.1f);
