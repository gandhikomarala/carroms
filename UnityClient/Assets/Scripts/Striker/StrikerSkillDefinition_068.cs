namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #068
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_068", menuName = "CarromArena/Striker #068")]
    public class StrikerSkillDefinition_068 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_068";
        [SerializeField] private float maxShotForce = 45.0f + (68 * 0.1f);
