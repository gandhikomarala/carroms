namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #196
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_196", menuName = "CarromArena/Striker #196")]
    public class StrikerSkillDefinition_196 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_196";
        [SerializeField] private float maxShotForce = 45.0f + (196 * 0.1f);
