namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #182
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_182", menuName = "CarromArena/Striker #182")]
    public class StrikerSkillDefinition_182 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_182";
        [SerializeField] private float maxShotForce = 45.0f + (182 * 0.1f);
