namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #113
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_113", menuName = "CarromArena/Striker #113")]
    public class StrikerSkillDefinition_113 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_113";
        [SerializeField] private float maxShotForce = 45.0f + (113 * 0.1f);
