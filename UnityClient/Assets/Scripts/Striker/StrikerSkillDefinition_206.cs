namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #206
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_206", menuName = "CarromArena/Striker #206")]
    public class StrikerSkillDefinition_206 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_206";
        [SerializeField] private float maxShotForce = 45.0f + (206 * 0.1f);
