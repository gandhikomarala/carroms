namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #180
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_180", menuName = "CarromArena/Striker #180")]
    public class StrikerSkillDefinition_180 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_180";
        [SerializeField] private float maxShotForce = 45.0f + (180 * 0.1f);
