namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #147
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_147", menuName = "CarromArena/Striker #147")]
    public class StrikerSkillDefinition_147 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_147";
        [SerializeField] private float maxShotForce = 45.0f + (147 * 0.1f);
