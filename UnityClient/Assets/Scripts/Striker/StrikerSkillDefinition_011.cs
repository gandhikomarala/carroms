namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #011
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_011", menuName = "CarromArena/Striker #011")]
    public class StrikerSkillDefinition_011 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_011";
        [SerializeField] private float maxShotForce = 45.0f + (11 * 0.1f);
