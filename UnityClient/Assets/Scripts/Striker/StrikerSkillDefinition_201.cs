namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #201
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_201", menuName = "CarromArena/Striker #201")]
    public class StrikerSkillDefinition_201 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_201";
        [SerializeField] private float maxShotForce = 45.0f + (201 * 0.1f);
