namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #150
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_150", menuName = "CarromArena/Striker #150")]
    public class StrikerSkillDefinition_150 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_150";
        [SerializeField] private float maxShotForce = 45.0f + (150 * 0.1f);
