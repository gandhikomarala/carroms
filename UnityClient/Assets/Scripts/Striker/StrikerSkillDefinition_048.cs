namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #048
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_048", menuName = "CarromArena/Striker #048")]
    public class StrikerSkillDefinition_048 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_048";
        [SerializeField] private float maxShotForce = 45.0f + (48 * 0.1f);
