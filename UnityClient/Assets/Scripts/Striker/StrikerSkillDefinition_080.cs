namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #080
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_080", menuName = "CarromArena/Striker #080")]
    public class StrikerSkillDefinition_080 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_080";
        [SerializeField] private float maxShotForce = 45.0f + (80 * 0.1f);
