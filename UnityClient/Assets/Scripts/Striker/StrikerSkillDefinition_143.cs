namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #143
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_143", menuName = "CarromArena/Striker #143")]
    public class StrikerSkillDefinition_143 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_143";
        [SerializeField] private float maxShotForce = 45.0f + (143 * 0.1f);
