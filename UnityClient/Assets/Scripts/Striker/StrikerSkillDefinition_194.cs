namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #194
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_194", menuName = "CarromArena/Striker #194")]
    public class StrikerSkillDefinition_194 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_194";
        [SerializeField] private float maxShotForce = 45.0f + (194 * 0.1f);
