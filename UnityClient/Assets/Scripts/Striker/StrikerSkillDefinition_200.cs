namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #200
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_200", menuName = "CarromArena/Striker #200")]
    public class StrikerSkillDefinition_200 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_200";
        [SerializeField] private float maxShotForce = 45.0f + (200 * 0.1f);
