namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #093
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_093", menuName = "CarromArena/Striker #093")]
    public class StrikerSkillDefinition_093 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_093";
        [SerializeField] private float maxShotForce = 45.0f + (93 * 0.1f);
