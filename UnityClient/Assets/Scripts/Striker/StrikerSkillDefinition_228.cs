namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #228
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_228", menuName = "CarromArena/Striker #228")]
    public class StrikerSkillDefinition_228 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_228";
        [SerializeField] private float maxShotForce = 45.0f + (228 * 0.1f);
