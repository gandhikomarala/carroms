namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #169
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_169", menuName = "CarromArena/Striker #169")]
    public class StrikerSkillDefinition_169 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_169";
        [SerializeField] private float maxShotForce = 45.0f + (169 * 0.1f);
