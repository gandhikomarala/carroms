namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #224
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_224", menuName = "CarromArena/Striker #224")]
    public class StrikerSkillDefinition_224 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_224";
        [SerializeField] private float maxShotForce = 45.0f + (224 * 0.1f);
