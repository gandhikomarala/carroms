namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #227
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_227", menuName = "CarromArena/Striker #227")]
    public class StrikerSkillDefinition_227 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_227";
        [SerializeField] private float maxShotForce = 45.0f + (227 * 0.1f);
