namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #049
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_049", menuName = "CarromArena/Striker #049")]
    public class StrikerSkillDefinition_049 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_049";
        [SerializeField] private float maxShotForce = 45.0f + (49 * 0.1f);
