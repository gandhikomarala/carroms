namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #186
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_186", menuName = "CarromArena/Striker #186")]
    public class StrikerSkillDefinition_186 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_186";
        [SerializeField] private float maxShotForce = 45.0f + (186 * 0.1f);
