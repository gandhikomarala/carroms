namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #120
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_120", menuName = "CarromArena/Striker #120")]
    public class StrikerSkillDefinition_120 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_120";
        [SerializeField] private float maxShotForce = 45.0f + (120 * 0.1f);
