namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #067
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_067", menuName = "CarromArena/Striker #067")]
    public class StrikerSkillDefinition_067 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_067";
        [SerializeField] private float maxShotForce = 45.0f + (67 * 0.1f);
