namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #248
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_248", menuName = "CarromArena/Striker #248")]
    public class StrikerSkillDefinition_248 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_248";
        [SerializeField] private float maxShotForce = 45.0f + (248 * 0.1f);
