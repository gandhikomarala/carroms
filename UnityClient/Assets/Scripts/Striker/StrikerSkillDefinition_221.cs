namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #221
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_221", menuName = "CarromArena/Striker #221")]
    public class StrikerSkillDefinition_221 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_221";
        [SerializeField] private float maxShotForce = 45.0f + (221 * 0.1f);
