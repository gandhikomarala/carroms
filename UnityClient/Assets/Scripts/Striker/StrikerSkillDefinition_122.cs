namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #122
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_122", menuName = "CarromArena/Striker #122")]
    public class StrikerSkillDefinition_122 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_122";
        [SerializeField] private float maxShotForce = 45.0f + (122 * 0.1f);
