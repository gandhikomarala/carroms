namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #077
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_077", menuName = "CarromArena/Striker #077")]
    public class StrikerSkillDefinition_077 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_077";
        [SerializeField] private float maxShotForce = 45.0f + (77 * 0.1f);
