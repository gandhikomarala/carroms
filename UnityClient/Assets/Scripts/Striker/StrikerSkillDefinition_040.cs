namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #040
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_040", menuName = "CarromArena/Striker #040")]
    public class StrikerSkillDefinition_040 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_040";
        [SerializeField] private float maxShotForce = 45.0f + (40 * 0.1f);
