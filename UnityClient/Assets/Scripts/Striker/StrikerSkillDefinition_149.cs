namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #149
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_149", menuName = "CarromArena/Striker #149")]
    public class StrikerSkillDefinition_149 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_149";
        [SerializeField] private float maxShotForce = 45.0f + (149 * 0.1f);
