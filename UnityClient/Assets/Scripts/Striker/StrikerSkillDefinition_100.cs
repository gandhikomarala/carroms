namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #100
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_100", menuName = "CarromArena/Striker #100")]
    public class StrikerSkillDefinition_100 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_100";
        [SerializeField] private float maxShotForce = 45.0f + (100 * 0.1f);
