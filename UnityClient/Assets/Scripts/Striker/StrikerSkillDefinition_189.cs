namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #189
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_189", menuName = "CarromArena/Striker #189")]
    public class StrikerSkillDefinition_189 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_189";
        [SerializeField] private float maxShotForce = 45.0f + (189 * 0.1f);
