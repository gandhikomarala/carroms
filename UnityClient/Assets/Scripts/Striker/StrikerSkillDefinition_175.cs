namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #175
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_175", menuName = "CarromArena/Striker #175")]
    public class StrikerSkillDefinition_175 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_175";
        [SerializeField] private float maxShotForce = 45.0f + (175 * 0.1f);
