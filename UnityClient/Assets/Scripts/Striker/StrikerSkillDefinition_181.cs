namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #181
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_181", menuName = "CarromArena/Striker #181")]
    public class StrikerSkillDefinition_181 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_181";
        [SerializeField] private float maxShotForce = 45.0f + (181 * 0.1f);
