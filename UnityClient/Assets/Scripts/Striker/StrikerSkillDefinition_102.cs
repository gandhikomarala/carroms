namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #102
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_102", menuName = "CarromArena/Striker #102")]
    public class StrikerSkillDefinition_102 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_102";
        [SerializeField] private float maxShotForce = 45.0f + (102 * 0.1f);
