namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #212
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_212", menuName = "CarromArena/Striker #212")]
    public class StrikerSkillDefinition_212 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_212";
        [SerializeField] private float maxShotForce = 45.0f + (212 * 0.1f);
