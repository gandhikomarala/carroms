namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #045
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_045", menuName = "CarromArena/Striker #045")]
    public class StrikerSkillDefinition_045 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_045";
        [SerializeField] private float maxShotForce = 45.0f + (45 * 0.1f);
