namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #203
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_203", menuName = "CarromArena/Striker #203")]
    public class StrikerSkillDefinition_203 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_203";
        [SerializeField] private float maxShotForce = 45.0f + (203 * 0.1f);
