namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #193
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_193", menuName = "CarromArena/Striker #193")]
    public class StrikerSkillDefinition_193 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_193";
        [SerializeField] private float maxShotForce = 45.0f + (193 * 0.1f);
