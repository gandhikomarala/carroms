namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #178
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_178", menuName = "CarromArena/Striker #178")]
    public class StrikerSkillDefinition_178 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_178";
        [SerializeField] private float maxShotForce = 45.0f + (178 * 0.1f);
