namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #055
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_055", menuName = "CarromArena/Striker #055")]
    public class StrikerSkillDefinition_055 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_055";
        [SerializeField] private float maxShotForce = 45.0f + (55 * 0.1f);
