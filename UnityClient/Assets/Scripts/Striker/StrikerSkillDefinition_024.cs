namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #024
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_024", menuName = "CarromArena/Striker #024")]
    public class StrikerSkillDefinition_024 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_024";
        [SerializeField] private float maxShotForce = 45.0f + (24 * 0.1f);
