namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #198
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_198", menuName = "CarromArena/Striker #198")]
    public class StrikerSkillDefinition_198 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_198";
        [SerializeField] private float maxShotForce = 45.0f + (198 * 0.1f);
