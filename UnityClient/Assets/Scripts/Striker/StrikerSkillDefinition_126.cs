namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #126
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_126", menuName = "CarromArena/Striker #126")]
    public class StrikerSkillDefinition_126 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_126";
        [SerializeField] private float maxShotForce = 45.0f + (126 * 0.1f);
