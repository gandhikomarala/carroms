namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #017
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_017", menuName = "CarromArena/Striker #017")]
    public class StrikerSkillDefinition_017 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_017";
        [SerializeField] private float maxShotForce = 45.0f + (17 * 0.1f);
