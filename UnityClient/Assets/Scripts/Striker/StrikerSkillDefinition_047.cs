namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #047
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_047", menuName = "CarromArena/Striker #047")]
    public class StrikerSkillDefinition_047 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_047";
        [SerializeField] private float maxShotForce = 45.0f + (47 * 0.1f);
