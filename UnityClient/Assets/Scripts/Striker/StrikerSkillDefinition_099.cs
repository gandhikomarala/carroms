namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #099
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_099", menuName = "CarromArena/Striker #099")]
    public class StrikerSkillDefinition_099 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_099";
        [SerializeField] private float maxShotForce = 45.0f + (99 * 0.1f);
