namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #029
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_029", menuName = "CarromArena/Striker #029")]
    public class StrikerSkillDefinition_029 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_029";
        [SerializeField] private float maxShotForce = 45.0f + (29 * 0.1f);
