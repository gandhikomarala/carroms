namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #128
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_128", menuName = "CarromArena/Striker #128")]
    public class StrikerSkillDefinition_128 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_128";
        [SerializeField] private float maxShotForce = 45.0f + (128 * 0.1f);
