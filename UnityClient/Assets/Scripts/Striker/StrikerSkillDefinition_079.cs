namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #079
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_079", menuName = "CarromArena/Striker #079")]
    public class StrikerSkillDefinition_079 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_079";
        [SerializeField] private float maxShotForce = 45.0f + (79 * 0.1f);
