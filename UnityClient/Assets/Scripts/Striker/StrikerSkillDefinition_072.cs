namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #072
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_072", menuName = "CarromArena/Striker #072")]
    public class StrikerSkillDefinition_072 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_072";
        [SerializeField] private float maxShotForce = 45.0f + (72 * 0.1f);
