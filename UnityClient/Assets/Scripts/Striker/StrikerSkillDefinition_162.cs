namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #162
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_162", menuName = "CarromArena/Striker #162")]
    public class StrikerSkillDefinition_162 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_162";
        [SerializeField] private float maxShotForce = 45.0f + (162 * 0.1f);
