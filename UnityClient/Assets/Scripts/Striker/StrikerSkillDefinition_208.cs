namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #208
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_208", menuName = "CarromArena/Striker #208")]
    public class StrikerSkillDefinition_208 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_208";
        [SerializeField] private float maxShotForce = 45.0f + (208 * 0.1f);
