namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #101
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_101", menuName = "CarromArena/Striker #101")]
    public class StrikerSkillDefinition_101 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_101";
        [SerializeField] private float maxShotForce = 45.0f + (101 * 0.1f);
