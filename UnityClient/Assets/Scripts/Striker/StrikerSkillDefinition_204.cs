namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #204
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_204", menuName = "CarromArena/Striker #204")]
    public class StrikerSkillDefinition_204 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_204";
        [SerializeField] private float maxShotForce = 45.0f + (204 * 0.1f);
