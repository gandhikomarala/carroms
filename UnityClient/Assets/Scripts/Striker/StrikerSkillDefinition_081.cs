namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #081
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_081", menuName = "CarromArena/Striker #081")]
    public class StrikerSkillDefinition_081 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_081";
        [SerializeField] private float maxShotForce = 45.0f + (81 * 0.1f);
