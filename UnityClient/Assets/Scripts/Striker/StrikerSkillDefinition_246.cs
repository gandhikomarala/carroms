namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #246
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_246", menuName = "CarromArena/Striker #246")]
    public class StrikerSkillDefinition_246 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_246";
        [SerializeField] private float maxShotForce = 45.0f + (246 * 0.1f);
