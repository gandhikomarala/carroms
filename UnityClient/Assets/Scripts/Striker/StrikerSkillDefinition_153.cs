namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #153
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_153", menuName = "CarromArena/Striker #153")]
    public class StrikerSkillDefinition_153 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_153";
        [SerializeField] private float maxShotForce = 45.0f + (153 * 0.1f);
