namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #038
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_038", menuName = "CarromArena/Striker #038")]
    public class StrikerSkillDefinition_038 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_038";
        [SerializeField] private float maxShotForce = 45.0f + (38 * 0.1f);
