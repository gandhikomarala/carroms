namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #115
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_115", menuName = "CarromArena/Striker #115")]
    public class StrikerSkillDefinition_115 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_115";
        [SerializeField] private float maxShotForce = 45.0f + (115 * 0.1f);
