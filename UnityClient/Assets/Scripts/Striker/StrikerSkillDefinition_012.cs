namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #012
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_012", menuName = "CarromArena/Striker #012")]
    public class StrikerSkillDefinition_012 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_012";
        [SerializeField] private float maxShotForce = 45.0f + (12 * 0.1f);
