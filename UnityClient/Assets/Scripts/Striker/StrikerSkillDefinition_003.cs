namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #003
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_003", menuName = "CarromArena/Striker #003")]
    public class StrikerSkillDefinition_003 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_003";
        [SerializeField] private float maxShotForce = 45.0f + (3 * 0.1f);
