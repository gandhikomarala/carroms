namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #205
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_205", menuName = "CarromArena/Striker #205")]
    public class StrikerSkillDefinition_205 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_205";
        [SerializeField] private float maxShotForce = 45.0f + (205 * 0.1f);
