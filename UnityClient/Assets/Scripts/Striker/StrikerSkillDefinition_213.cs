namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #213
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_213", menuName = "CarromArena/Striker #213")]
    public class StrikerSkillDefinition_213 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_213";
        [SerializeField] private float maxShotForce = 45.0f + (213 * 0.1f);
