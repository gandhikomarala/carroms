namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #129
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_129", menuName = "CarromArena/Striker #129")]
    public class StrikerSkillDefinition_129 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_129";
        [SerializeField] private float maxShotForce = 45.0f + (129 * 0.1f);
