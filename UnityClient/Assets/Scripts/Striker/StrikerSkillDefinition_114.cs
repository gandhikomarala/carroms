namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #114
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_114", menuName = "CarromArena/Striker #114")]
    public class StrikerSkillDefinition_114 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_114";
        [SerializeField] private float maxShotForce = 45.0f + (114 * 0.1f);
