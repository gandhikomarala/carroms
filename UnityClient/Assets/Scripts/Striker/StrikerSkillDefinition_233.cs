namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #233
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_233", menuName = "CarromArena/Striker #233")]
    public class StrikerSkillDefinition_233 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_233";
        [SerializeField] private float maxShotForce = 45.0f + (233 * 0.1f);
