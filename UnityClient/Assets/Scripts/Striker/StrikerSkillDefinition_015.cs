namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #015
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_015", menuName = "CarromArena/Striker #015")]
    public class StrikerSkillDefinition_015 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_015";
        [SerializeField] private float maxShotForce = 45.0f + (15 * 0.1f);
