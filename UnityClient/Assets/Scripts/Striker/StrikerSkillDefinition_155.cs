namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #155
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_155", menuName = "CarromArena/Striker #155")]
    public class StrikerSkillDefinition_155 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_155";
        [SerializeField] private float maxShotForce = 45.0f + (155 * 0.1f);
