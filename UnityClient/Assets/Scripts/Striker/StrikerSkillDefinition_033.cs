namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #033
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_033", menuName = "CarromArena/Striker #033")]
    public class StrikerSkillDefinition_033 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_033";
        [SerializeField] private float maxShotForce = 45.0f + (33 * 0.1f);
