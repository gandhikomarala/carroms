namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #146
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_146", menuName = "CarromArena/Striker #146")]
    public class StrikerSkillDefinition_146 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_146";
        [SerializeField] private float maxShotForce = 45.0f + (146 * 0.1f);
