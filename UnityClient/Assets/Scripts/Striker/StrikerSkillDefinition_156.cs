namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #156
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_156", menuName = "CarromArena/Striker #156")]
    public class StrikerSkillDefinition_156 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_156";
        [SerializeField] private float maxShotForce = 45.0f + (156 * 0.1f);
