namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #148
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_148", menuName = "CarromArena/Striker #148")]
    public class StrikerSkillDefinition_148 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_148";
        [SerializeField] private float maxShotForce = 45.0f + (148 * 0.1f);
