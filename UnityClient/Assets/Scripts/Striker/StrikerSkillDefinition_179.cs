namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #179
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_179", menuName = "CarromArena/Striker #179")]
    public class StrikerSkillDefinition_179 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_179";
        [SerializeField] private float maxShotForce = 45.0f + (179 * 0.1f);
