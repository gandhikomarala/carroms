namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #006
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_006", menuName = "CarromArena/Striker #006")]
    public class StrikerSkillDefinition_006 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_006";
        [SerializeField] private float maxShotForce = 45.0f + (6 * 0.1f);
