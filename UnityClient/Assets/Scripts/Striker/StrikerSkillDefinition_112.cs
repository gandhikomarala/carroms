namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #112
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_112", menuName = "CarromArena/Striker #112")]
    public class StrikerSkillDefinition_112 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_112";
        [SerializeField] private float maxShotForce = 45.0f + (112 * 0.1f);
