namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #004
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_004", menuName = "CarromArena/Striker #004")]
    public class StrikerSkillDefinition_004 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_004";
        [SerializeField] private float maxShotForce = 45.0f + (4 * 0.1f);
