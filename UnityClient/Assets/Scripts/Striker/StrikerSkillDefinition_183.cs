namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #183
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_183", menuName = "CarromArena/Striker #183")]
    public class StrikerSkillDefinition_183 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_183";
        [SerializeField] private float maxShotForce = 45.0f + (183 * 0.1f);
