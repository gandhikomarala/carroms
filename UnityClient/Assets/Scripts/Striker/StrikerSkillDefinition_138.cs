namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #138
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_138", menuName = "CarromArena/Striker #138")]
    public class StrikerSkillDefinition_138 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_138";
        [SerializeField] private float maxShotForce = 45.0f + (138 * 0.1f);
