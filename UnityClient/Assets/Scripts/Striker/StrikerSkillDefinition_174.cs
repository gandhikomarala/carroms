namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #174
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_174", menuName = "CarromArena/Striker #174")]
    public class StrikerSkillDefinition_174 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_174";
        [SerializeField] private float maxShotForce = 45.0f + (174 * 0.1f);
