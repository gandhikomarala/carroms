namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #057
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_057", menuName = "CarromArena/Striker #057")]
    public class StrikerSkillDefinition_057 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_057";
        [SerializeField] private float maxShotForce = 45.0f + (57 * 0.1f);
