namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #220
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_220", menuName = "CarromArena/Striker #220")]
    public class StrikerSkillDefinition_220 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_220";
        [SerializeField] private float maxShotForce = 45.0f + (220 * 0.1f);
