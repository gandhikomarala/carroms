namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #110
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_110", menuName = "CarromArena/Striker #110")]
    public class StrikerSkillDefinition_110 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_110";
        [SerializeField] private float maxShotForce = 45.0f + (110 * 0.1f);
