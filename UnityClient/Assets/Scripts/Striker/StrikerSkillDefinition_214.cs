namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #214
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_214", menuName = "CarromArena/Striker #214")]
    public class StrikerSkillDefinition_214 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_214";
        [SerializeField] private float maxShotForce = 45.0f + (214 * 0.1f);
