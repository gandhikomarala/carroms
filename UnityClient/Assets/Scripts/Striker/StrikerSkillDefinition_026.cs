namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #026
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_026", menuName = "CarromArena/Striker #026")]
    public class StrikerSkillDefinition_026 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_026";
        [SerializeField] private float maxShotForce = 45.0f + (26 * 0.1f);
