namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #088
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_088", menuName = "CarromArena/Striker #088")]
    public class StrikerSkillDefinition_088 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_088";
        [SerializeField] private float maxShotForce = 45.0f + (88 * 0.1f);
