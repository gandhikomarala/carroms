namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #238
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_238", menuName = "CarromArena/Striker #238")]
    public class StrikerSkillDefinition_238 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_238";
        [SerializeField] private float maxShotForce = 45.0f + (238 * 0.1f);
