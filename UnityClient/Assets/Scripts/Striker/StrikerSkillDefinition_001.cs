namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #001
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_001", menuName = "CarromArena/Striker #001")]
    public class StrikerSkillDefinition_001 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_001";
        [SerializeField] private float maxShotForce = 45.0f + (1 * 0.1f);
