namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #139
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_139", menuName = "CarromArena/Striker #139")]
    public class StrikerSkillDefinition_139 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_139";
        [SerializeField] private float maxShotForce = 45.0f + (139 * 0.1f);
