namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #010
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_010", menuName = "CarromArena/Striker #010")]
    public class StrikerSkillDefinition_010 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_010";
        [SerializeField] private float maxShotForce = 45.0f + (10 * 0.1f);
