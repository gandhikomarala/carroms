namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #075
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_075", menuName = "CarromArena/Striker #075")]
    public class StrikerSkillDefinition_075 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_075";
        [SerializeField] private float maxShotForce = 45.0f + (75 * 0.1f);
