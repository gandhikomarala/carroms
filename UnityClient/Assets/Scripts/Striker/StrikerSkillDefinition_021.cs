namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #021
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_021", menuName = "CarromArena/Striker #021")]
    public class StrikerSkillDefinition_021 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_021";
        [SerializeField] private float maxShotForce = 45.0f + (21 * 0.1f);
