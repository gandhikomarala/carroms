namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #124
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_124", menuName = "CarromArena/Striker #124")]
    public class StrikerSkillDefinition_124 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_124";
        [SerializeField] private float maxShotForce = 45.0f + (124 * 0.1f);
