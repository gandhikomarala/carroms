namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #013
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_013", menuName = "CarromArena/Striker #013")]
    public class StrikerSkillDefinition_013 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_013";
        [SerializeField] private float maxShotForce = 45.0f + (13 * 0.1f);
