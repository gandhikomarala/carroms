namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #235
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_235", menuName = "CarromArena/Striker #235")]
    public class StrikerSkillDefinition_235 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_235";
        [SerializeField] private float maxShotForce = 45.0f + (235 * 0.1f);
