namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #151
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_151", menuName = "CarromArena/Striker #151")]
    public class StrikerSkillDefinition_151 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_151";
        [SerializeField] private float maxShotForce = 45.0f + (151 * 0.1f);
