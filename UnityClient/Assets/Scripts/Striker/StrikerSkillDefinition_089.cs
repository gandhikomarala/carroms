namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #089
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_089", menuName = "CarromArena/Striker #089")]
    public class StrikerSkillDefinition_089 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_089";
        [SerializeField] private float maxShotForce = 45.0f + (89 * 0.1f);
