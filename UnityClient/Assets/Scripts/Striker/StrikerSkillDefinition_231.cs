namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #231
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_231", menuName = "CarromArena/Striker #231")]
    public class StrikerSkillDefinition_231 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_231";
        [SerializeField] private float maxShotForce = 45.0f + (231 * 0.1f);
