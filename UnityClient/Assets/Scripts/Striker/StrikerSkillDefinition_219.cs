namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #219
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_219", menuName = "CarromArena/Striker #219")]
    public class StrikerSkillDefinition_219 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_219";
        [SerializeField] private float maxShotForce = 45.0f + (219 * 0.1f);
