namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #008
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_008", menuName = "CarromArena/Striker #008")]
    public class StrikerSkillDefinition_008 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_008";
        [SerializeField] private float maxShotForce = 45.0f + (8 * 0.1f);
