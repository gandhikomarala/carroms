namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #140
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_140", menuName = "CarromArena/Striker #140")]
    public class StrikerSkillDefinition_140 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_140";
        [SerializeField] private float maxShotForce = 45.0f + (140 * 0.1f);
