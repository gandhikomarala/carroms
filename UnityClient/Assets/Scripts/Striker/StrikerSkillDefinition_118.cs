namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #118
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_118", menuName = "CarromArena/Striker #118")]
    public class StrikerSkillDefinition_118 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_118";
        [SerializeField] private float maxShotForce = 45.0f + (118 * 0.1f);
