namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #216
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_216", menuName = "CarromArena/Striker #216")]
    public class StrikerSkillDefinition_216 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_216";
        [SerializeField] private float maxShotForce = 45.0f + (216 * 0.1f);
