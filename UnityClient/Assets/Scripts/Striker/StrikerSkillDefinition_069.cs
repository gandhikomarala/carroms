namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #069
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_069", menuName = "CarromArena/Striker #069")]
    public class StrikerSkillDefinition_069 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_069";
        [SerializeField] private float maxShotForce = 45.0f + (69 * 0.1f);
