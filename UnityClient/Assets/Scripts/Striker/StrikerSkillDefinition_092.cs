namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #092
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_092", menuName = "CarromArena/Striker #092")]
    public class StrikerSkillDefinition_092 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_092";
        [SerializeField] private float maxShotForce = 45.0f + (92 * 0.1f);
