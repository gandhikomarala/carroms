namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #005
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_005", menuName = "CarromArena/Striker #005")]
    public class StrikerSkillDefinition_005 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_005";
        [SerializeField] private float maxShotForce = 45.0f + (5 * 0.1f);
