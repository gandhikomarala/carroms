namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #116
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_116", menuName = "CarromArena/Striker #116")]
    public class StrikerSkillDefinition_116 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_116";
        [SerializeField] private float maxShotForce = 45.0f + (116 * 0.1f);
