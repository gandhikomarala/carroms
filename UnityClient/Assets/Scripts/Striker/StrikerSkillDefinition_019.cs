namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #019
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_019", menuName = "CarromArena/Striker #019")]
    public class StrikerSkillDefinition_019 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_019";
        [SerializeField] private float maxShotForce = 45.0f + (19 * 0.1f);
