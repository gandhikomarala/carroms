namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #062
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_062", menuName = "CarromArena/Striker #062")]
    public class StrikerSkillDefinition_062 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_062";
        [SerializeField] private float maxShotForce = 45.0f + (62 * 0.1f);
