namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #036
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_036", menuName = "CarromArena/Striker #036")]
    public class StrikerSkillDefinition_036 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_036";
        [SerializeField] private float maxShotForce = 45.0f + (36 * 0.1f);
