namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #002
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_002", menuName = "CarromArena/Striker #002")]
    public class StrikerSkillDefinition_002 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_002";
        [SerializeField] private float maxShotForce = 45.0f + (2 * 0.1f);
