namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #152
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_152", menuName = "CarromArena/Striker #152")]
    public class StrikerSkillDefinition_152 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_152";
        [SerializeField] private float maxShotForce = 45.0f + (152 * 0.1f);
