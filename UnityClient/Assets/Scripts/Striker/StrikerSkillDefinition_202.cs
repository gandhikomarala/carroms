namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #202
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_202", menuName = "CarromArena/Striker #202")]
    public class StrikerSkillDefinition_202 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_202";
        [SerializeField] private float maxShotForce = 45.0f + (202 * 0.1f);
