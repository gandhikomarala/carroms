namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #106
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_106", menuName = "CarromArena/Striker #106")]
    public class StrikerSkillDefinition_106 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_106";
        [SerializeField] private float maxShotForce = 45.0f + (106 * 0.1f);
