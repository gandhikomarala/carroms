namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #094
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_094", menuName = "CarromArena/Striker #094")]
    public class StrikerSkillDefinition_094 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_094";
        [SerializeField] private float maxShotForce = 45.0f + (94 * 0.1f);
