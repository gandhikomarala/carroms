namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #025
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_025", menuName = "CarromArena/Striker #025")]
    public class StrikerSkillDefinition_025 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_025";
        [SerializeField] private float maxShotForce = 45.0f + (25 * 0.1f);
