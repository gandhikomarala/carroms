namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #051
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_051", menuName = "CarromArena/Striker #051")]
    public class StrikerSkillDefinition_051 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_051";
        [SerializeField] private float maxShotForce = 45.0f + (51 * 0.1f);
