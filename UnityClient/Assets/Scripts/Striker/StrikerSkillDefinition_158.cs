namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #158
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_158", menuName = "CarromArena/Striker #158")]
    public class StrikerSkillDefinition_158 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_158";
        [SerializeField] private float maxShotForce = 45.0f + (158 * 0.1f);
