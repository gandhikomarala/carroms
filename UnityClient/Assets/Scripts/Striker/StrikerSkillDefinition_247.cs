namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #247
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_247", menuName = "CarromArena/Striker #247")]
    public class StrikerSkillDefinition_247 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_247";
        [SerializeField] private float maxShotForce = 45.0f + (247 * 0.1f);
