namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #058
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_058", menuName = "CarromArena/Striker #058")]
    public class StrikerSkillDefinition_058 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_058";
        [SerializeField] private float maxShotForce = 45.0f + (58 * 0.1f);
