namespace CarromArena.Striker
{
    ...
    /// <summary>
    /// Striker Tuning & Skill Modifier #167
    /// Controls impulse force scaling, spin drag coefficients, and aim preview line precision.
    /// </summary>
    [CreateAssetMenu(fileName = "StrikerSkill_167", menuName = "CarromArena/Striker #167")]
    public class StrikerSkillDefinition_167 : ScriptableObject
    {
        [Header("Striker Mechanics")]
        [SerializeField] private string strikerId = "STRIKER_167";
        [SerializeField] private float maxShotForce = 45.0f + (167 * 0.1f);
