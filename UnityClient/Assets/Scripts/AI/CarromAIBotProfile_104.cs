namespace CarromArena.AI
{
    ...
    /// <summary>
    /// Deterministic Carrom AI Opponent Profile #104
    /// Plans candidate bank shots, pocket angle cuts, and applies deliberate difficulty error margins.
    /// </summary>
    [CreateAssetMenu(fileName = "AIBotProfile_104", menuName = "CarromArena/AI Profile #104")]
    public class CarromAIBotProfile_104 : ScriptableObject
    {
        public enum AIDifficulty { Easy, Medium, Hard, Expert }

        [SerializeField] private string botName = "Grandmaster Bot #104";
