namespace CarromArena.AI
{
    ...
    /// <summary>
    /// Deterministic Carrom AI Opponent Profile #039
    /// Plans candidate bank shots, pocket angle cuts, and applies deliberate difficulty error margins.
    /// </summary>
    [CreateAssetMenu(fileName = "AIBotProfile_039", menuName = "CarromArena/AI Profile #039")]
    public class CarromAIBotProfile_039 : ScriptableObject
    {
        public enum AIDifficulty { Easy, Medium, Hard, Expert }

        [SerializeField] private string botName = "Grandmaster Bot #039";
