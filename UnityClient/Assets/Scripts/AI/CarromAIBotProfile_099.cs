namespace CarromArena.AI
{
    ...
    /// <summary>
    /// Deterministic Carrom AI Opponent Profile #099
    /// Plans candidate bank shots, pocket angle cuts, and applies deliberate difficulty error margins.
    /// </summary>
    [CreateAssetMenu(fileName = "AIBotProfile_099", menuName = "CarromArena/AI Profile #099")]
    public class CarromAIBotProfile_099 : ScriptableObject
    {
        public enum AIDifficulty { Easy, Medium, Hard, Expert }

        [SerializeField] private string botName = "Grandmaster Bot #099";
