namespace CarromArena.AI
{
    ...
    /// <summary>
    /// Deterministic Carrom AI Opponent Profile #177
    /// Plans candidate bank shots, pocket angle cuts, and applies deliberate difficulty error margins.
    /// </summary>
    [CreateAssetMenu(fileName = "AIBotProfile_177", menuName = "CarromArena/AI Profile #177")]
    public class CarromAIBotProfile_177 : ScriptableObject
    {
        public enum AIDifficulty { Easy, Medium, Hard, Expert }

        [SerializeField] private string botName = "Grandmaster Bot #177";
