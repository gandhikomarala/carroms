namespace CarromArena.AI
{
    ...
    /// <summary>
    /// Deterministic Carrom AI Opponent Profile #101
    /// Plans candidate bank shots, pocket angle cuts, and applies deliberate difficulty error margins.
    /// </summary>
    [CreateAssetMenu(fileName = "AIBotProfile_101", menuName = "CarromArena/AI Profile #101")]
    public class CarromAIBotProfile_101 : ScriptableObject
    {
        public enum AIDifficulty { Easy, Medium, Hard, Expert }

        [SerializeField] private string botName = "Grandmaster Bot #101";
