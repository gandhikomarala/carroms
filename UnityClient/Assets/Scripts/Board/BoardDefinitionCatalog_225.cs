namespace CarromArena.Board
{
    ...
    /// <summary>
    /// Carrom Board Physical Surface & Wood Texture Definition #225
    /// Controls board dimensions, pocket radiuses, baseline coordinates, and friction coefficients.
    /// </summary>
    [CreateAssetMenu(fileName = "BoardDefinition_225", menuName = "CarromArena/Board #225")]
    public class BoardDefinitionCatalog_225 : ScriptableObject
    {
        public enum WoodFinish { Rosewood, AcrylicGloss, NeonCyber, RoyalIvory, MarbleElite }

        [Header("Board Surface Properties")]
        [SerializeField] private string boardId = "BOARD_225";
        [SerializeField] private string boardTitle = "Tournament Arena #225";
