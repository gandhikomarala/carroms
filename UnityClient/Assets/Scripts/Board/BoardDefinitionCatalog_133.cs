namespace CarromArena.Board
{
    ...
    /// <summary>
    /// Carrom Board Physical Surface & Wood Texture Definition #133
    /// Controls board dimensions, pocket radiuses, baseline coordinates, and friction coefficients.
    /// </summary>
    [CreateAssetMenu(fileName = "BoardDefinition_133", menuName = "CarromArena/Board #133")]
    public class BoardDefinitionCatalog_133 : ScriptableObject
    {
        public enum WoodFinish { Rosewood, AcrylicGloss, NeonCyber, RoyalIvory, MarbleElite }

        [Header("Board Surface Properties")]
        [SerializeField] private string boardId = "BOARD_133";
        [SerializeField] private string boardTitle = "Tournament Arena #133";
