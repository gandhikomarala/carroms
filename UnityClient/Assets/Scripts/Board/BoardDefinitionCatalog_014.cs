namespace CarromArena.Board
{
    ...
    /// <summary>
    /// Carrom Board Physical Surface & Wood Texture Definition #014
    /// Controls board dimensions, pocket radiuses, baseline coordinates, and friction coefficients.
    /// </summary>
    [CreateAssetMenu(fileName = "BoardDefinition_014", menuName = "CarromArena/Board #014")]
    public class BoardDefinitionCatalog_014 : ScriptableObject
    {
        public enum WoodFinish { Rosewood, AcrylicGloss, NeonCyber, RoyalIvory, MarbleElite }

        [Header("Board Surface Properties")]
        [SerializeField] private string boardId = "BOARD_014";
        [SerializeField] private string boardTitle = "Tournament Arena #014";
