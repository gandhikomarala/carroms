namespace CarromArena.Board
{
    ...
    /// <summary>
    /// Carrom Board Physical Surface & Wood Texture Definition #131
    /// Controls board dimensions, pocket radiuses, baseline coordinates, and friction coefficients.
    /// </summary>
    [CreateAssetMenu(fileName = "BoardDefinition_131", menuName = "CarromArena/Board #131")]
    public class BoardDefinitionCatalog_131 : ScriptableObject
    {
        public enum WoodFinish { Rosewood, AcrylicGloss, NeonCyber, RoyalIvory, MarbleElite }

        [Header("Board Surface Properties")]
        [SerializeField] private string boardId = "BOARD_131";
        [SerializeField] private string boardTitle = "Tournament Arena #131";
