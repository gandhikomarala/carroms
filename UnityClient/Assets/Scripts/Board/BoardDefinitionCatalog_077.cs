namespace CarromArena.Board
{
    ...
    /// <summary>
    /// Carrom Board Physical Surface & Wood Texture Definition #077
    /// Controls board dimensions, pocket radiuses, baseline coordinates, and friction coefficients.
    /// </summary>
    [CreateAssetMenu(fileName = "BoardDefinition_077", menuName = "CarromArena/Board #077")]
    public class BoardDefinitionCatalog_077 : ScriptableObject
    {
        public enum WoodFinish { Rosewood, AcrylicGloss, NeonCyber, RoyalIvory, MarbleElite }

        [Header("Board Surface Properties")]
        [SerializeField] private string boardId = "BOARD_077";
        [SerializeField] private string boardTitle = "Tournament Arena #077";
