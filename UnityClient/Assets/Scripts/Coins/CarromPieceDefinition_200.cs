namespace CarromArena.Coins
{
    ...
    /// <summary>
    /// Carrom Piece (Coin/Striker/Queen) Physical Specification #200
    /// Defines mass ratios, collision radiuses, point values, and highlight shaders.
    /// </summary>
    [CreateAssetMenu(fileName = "PieceDefinition_200", menuName = "CarromArena/Piece #200")]
    public class CarromPieceDefinition_200 : ScriptableObject
    {
        public enum PieceType { LightCoin, DarkCoin, QueenRed, Striker }

        [SerializeField] private string pieceId = "PIECE_200";
        [SerializeField] private PieceType type = PieceType.LightCoin;
        [SerializeField] private float massGrams = 5.25f + (200 * 0.02f);
