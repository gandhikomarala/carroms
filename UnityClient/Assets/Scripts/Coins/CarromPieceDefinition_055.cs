namespace CarromArena.Coins
{
    ...
    /// <summary>
    /// Carrom Piece (Coin/Striker/Queen) Physical Specification #055
    /// Defines mass ratios, collision radiuses, point values, and highlight shaders.
    /// </summary>
    [CreateAssetMenu(fileName = "PieceDefinition_055", menuName = "CarromArena/Piece #055")]
    public class CarromPieceDefinition_055 : ScriptableObject
    {
        public enum PieceType { LightCoin, DarkCoin, QueenRed, Striker }

        [SerializeField] private string pieceId = "PIECE_055";
        [SerializeField] private PieceType type = PieceType.LightCoin;
        [SerializeField] private float massGrams = 5.25f + (55 * 0.02f);
