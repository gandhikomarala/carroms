namespace CarromArena.Coins
{
    ...
    /// <summary>
    /// Carrom Piece (Coin/Striker/Queen) Physical Specification #247
    /// Defines mass ratios, collision radiuses, point values, and highlight shaders.
    /// </summary>
    [CreateAssetMenu(fileName = "PieceDefinition_247", menuName = "CarromArena/Piece #247")]
    public class CarromPieceDefinition_247 : ScriptableObject
    {
        public enum PieceType { LightCoin, DarkCoin, QueenRed, Striker }

        [SerializeField] private string pieceId = "PIECE_247";
        [SerializeField] private PieceType type = PieceType.LightCoin;
        [SerializeField] private float massGrams = 5.25f + (247 * 0.02f);
