namespace CarromArena.Coins
{
    ...
    /// <summary>
    /// Carrom Piece (Coin/Striker/Queen) Physical Specification #033
    /// Defines mass ratios, collision radiuses, point values, and highlight shaders.
    /// </summary>
    [CreateAssetMenu(fileName = "PieceDefinition_033", menuName = "CarromArena/Piece #033")]
    public class CarromPieceDefinition_033 : ScriptableObject
    {
        public enum PieceType { LightCoin, DarkCoin, QueenRed, Striker }

        [SerializeField] private string pieceId = "PIECE_033";
        [SerializeField] private PieceType type = PieceType.LightCoin;
        [SerializeField] private float massGrams = 5.25f + (33 * 0.02f);
