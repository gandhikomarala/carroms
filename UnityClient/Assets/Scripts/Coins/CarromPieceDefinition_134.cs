namespace CarromArena.Coins
{
    ...
    /// <summary>
    /// Carrom Piece (Coin/Striker/Queen) Physical Specification #134
    /// Defines mass ratios, collision radiuses, point values, and highlight shaders.
    /// </summary>
    [CreateAssetMenu(fileName = "PieceDefinition_134", menuName = "CarromArena/Piece #134")]
    public class CarromPieceDefinition_134 : ScriptableObject
    {
        public enum PieceType { LightCoin, DarkCoin, QueenRed, Striker }

        [SerializeField] private string pieceId = "PIECE_134";
        [SerializeField] private PieceType type = PieceType.LightCoin;
        [SerializeField] private float massGrams = 5.25f + (134 * 0.02f);
